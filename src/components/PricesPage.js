        ...
        <div className="prices">
          ...
          <main className="prices__content">
            <p className="prices__text">
              * Оплата: наличная, безналичная или по карте
            </p>
            <table className="prices__table">
              <tbody>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Прием (осмотр, консультация) врача-акушера-гинеколога с
                    ультразвуковым исследованием яичников для оценки
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Комплексная услуга по медикаментозному прерыванию
                    беременности
                  </td>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Марсупиализация абсцесса или кисты большой железы преддверия
                    влагалища
                  </td>
                  <td className="prices__table-td">7500</td>
                </tr>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Аускультация плода с помощью фетального доплера
                  </td>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое исследование плода при сроке беременности до
                    тринадцати недель
                  </td>
                  <td className="prices__table-td">1500</td>
                </tr>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое скрининговое исследование при сроке
                    беременности одиннадцатая - четырнадцатая недели по оценке
                    антенатального развития плода с целью выявления хромосомных
                    аномалий, пороков развития, рисков задержки роста плода,
                    преждевременных родов, преэклампсии (скрининг I)
                  </td>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое скрининговое исследование при сроке
                    беременности одиннадцатая - четырнадцатая недели по оценке
                    антенатального развития плодов с целью выявления хромосомных
                    аномалий, пороков развития, рисков задержки роста плода,
                    преждевременных родов, преэклампсии при многоплодной
                    беременности (скрининг I)
                  </td>
                  <td className="prices__table-td">2500</td>
                </tr>
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое скрининговое исследование при сроке
                    беременности девятнадцатая - двадцать первая недели по
                    оценке антенатального развития плода с целью выявления
                    хромосомных аномалий, пороков развития, рисков задержки
                    роста плода, преждевременных родов, преэклампсии (скрининг
                    II)
                  </td>
                  <td className="prices__table-td">3500</td>
                </tr>
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое скрининговое исследование при сроке
                    беременности девятнадцатая - двадцать первая недели по
                    оценке антенатального развития плодов с целью выявления
                    хромосомных аномалий, пороков развития, рисков задержки
                    роста плода, преждевременных родов, преэклампсии при
                    многоплодной беременности (скрининг II)
                  </td>
                  <td className="prices__table-td">3500</td>
                </tr>
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое исследование плода в III триместре
                    беременности
                  </td>
                  <td className="prices__table-td">3500</td>
                </tr>
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое исследование плодов в III триместре
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Улитразвуковое исследование шейки матки(УЗ-цервикометрия)
                  </td>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ультразвуковое исследование матки трансвагинальное
                  </td>
                  <td className="prices__table-td">1500</td>
                </tr>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Введение исскуственных имплантатов в мягкие ткани
                  </td>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Введение исскуственных наполнителей в мягкие ткани половых
                    органов, с целью коррекции формы.
                  </td>
                  <td className="prices__table-td">
                    В зависимости от количества введённого препарата
                  </td>
                </tr>
                <tr className="prices__table-tr">
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Прием (осмотр, консультация) врача-терапевта участкового
                    первичный
                  </td>
                  <td className="prices__table-td">1500</td>
                </tr>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Внутривенное введение лекарственных препаратов (без
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Введение акушерского разгружающего поддерживающего кольца
                    (пессария)
                  </td>
                  <td className="prices__table-td">3000</td>
                </tr>
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Извлечение акушерского разгружающего поддерживающего кольца
                    (пессария)
                  </td>
                  <td className="prices__table-td">2000</td>
                </tr>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ежедневный осмотр врачом-терапевтом с наблюдением и уходом
                    среднего и младшего медицинского персонала в отделении
                    стационара
                  </td>
                  <td className="prices__table-td">1500</td>
                </tr>
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Воздействие лечебной грязью вагинально{" "}
                  </td>
                  <td className="prices__table-td">2500</td>
                </tr>
                <tr className="prices__table-tr">
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ежедневный осмотр врачом-акушером-гинекологом, с наблюдением
                    и уходом среднего и младшего медицинского персонала в
                ...
                <tr className="prices__table-tr">
                  ...
                  <td className="prices__table-td">
                    Ежедневный осмотр врачом-акушером-гинекологом беременной, с
